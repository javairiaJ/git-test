...
?>
<div class="col-md-6">
	@include('admin/templates/product_launch_template')
</div>
<div class="col-md-6">
	<div class="box box-default">
		<div class="box-body">
			<div class="form-group">
				...
				{!! Form::text('productName', null, array('class' => 'form-control productName',$sRequired) ) !!}
			</div>
			<div class="form-group">
				{!! Form::label('Date *') !!}
			...
			<div class="form-group">
				{!! Form::label('Image') !!}
				<input type="file" uploader="uploader" id="img" name="file" accept=".jpg,.jpeg,.png,.gif,.bmp,.PNG">
			</div>
			<div class="form-group">
				{!! Form::label('Regards *') !!}
